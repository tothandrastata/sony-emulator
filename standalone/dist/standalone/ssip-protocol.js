 ...
 */
function buildPacket(messageType, command, parameters) {
 ...
 */
function buildAnswerPacket(command, value) {
 ...
 */
function buildErrorPacket(command) {
 ...
 */
function buildNotifyPacket(command, value) {
 ...
 */
function createDecimalParams(value) {
